...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pushToggle = (ImageView) view.findViewById(R.id.imvPushToggle);
        pushToggle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!chkPush) {
                    pushToggle.setImageResource(R.drawable.ic_toggle_off);
                    chkPush=true;
                }else{
                    pushToggle.setImageResource(R.drawable.ic_toggle_on);
                    chkPush=false;
                }
            }
        });
