...
public class UpdateLocation extends Service implements
        LocationListener, GetLocationUpdates.LocationUpdates {
    ...
    public void onCreate() {
        ...
        GetLocationUpdates locationUpdate = new GetLocationUpdates(UpdateLocation.this);
    ...
    public void setSellerLocation() {
        if (currentLocation != null) {
            Log.e("latlong", "" + currentLocation.getLatitude() + currentLocation.getLongitude());
