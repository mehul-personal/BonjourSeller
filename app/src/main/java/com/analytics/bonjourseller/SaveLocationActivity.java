        ...
        setLocation.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (locationName.getText().toString().isEmpty()) {
                    ...
                    Intent i = new Intent(SaveLocationActivity.this, NavigationDrawerActivity.class);
                    i.putExtra("LOCATION_NAME", locationName.getText().toString());
                    if (status.equalsIgnoreCase("UPDATE")) {
